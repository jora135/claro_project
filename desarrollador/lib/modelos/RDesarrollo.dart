...
import 'package:desarrollador/WDesarrollo.dart';
...
class Esquema_R2 extends StatefulWidget {
  const Esquema_R2({Key? key, required this.titulo}) : super(key: key);
  final String titulo;

  @override
  State<Esquema_R2> createState() => _Esquema_R_State();
}

class _Esquema_R_State extends State<Esquema_R2> {
  ...
  Stream<QuerySnapshot> _consultaStream = FirebaseFirestore.instance
      .collection('Proyecto')
      .where('estadop', isEqualTo: 'Desarrollo')
      .snapshots(); 
