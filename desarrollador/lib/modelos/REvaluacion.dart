...
import 'package:desarrollador/WEvaluacion.dart';
...
class Esquema_R1 extends StatefulWidget {
  const Esquema_R1({Key? key, required this.titulo}) : super(key: key);
  final String titulo;

  @override
  State<Esquema_R1> createState() => _Esquema_R_State();
}

class _Esquema_R_State extends State<Esquema_R1> {
  ...
  Stream<QuerySnapshot> _consultaStream = FirebaseFirestore.instance
      .collection('Proyecto')
      .where('estadop', isEqualTo: 'En Evaluación')
      .snapshots();
